...
<body class = "container-fluid">
                    ...
                    <div class="card-body">
                        <form action="impresion.php" method="get">
                            <div class="form-group">
                                <label for="employeeId">Identificación de Empleado:</label>
    ...
    <form action="impXML.php" method="get">
        ...
        <div class="form-group">
            <label for="employeeId">Identificación del Empleado:</label>
            <input type="text" class="form-control" id="employeeId" name="employee_id" required>
        </div>
        <button type="submit" class="btn btn-warning btn-block" name="action" value="view">Ver Reporte XML</button>
        <button type="submit" class="btn btn-danger btn-block" name="action" value="download">Descargar Reporte XML</button>
    </form>
    </div>
</div>
            </div>
